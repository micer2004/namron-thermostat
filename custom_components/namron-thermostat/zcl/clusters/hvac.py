...
https://home-assistant.io/integrations/zha/namron
"""
...
class ThermostatChannel(ZigbeeChannel):
    ...
    REPORT_CONFIG = (
        ...
        AttrReportConfig(attr="outdoor_temperature", config=REPORT_CONFIG_CLIMATE),
        AttrReportConfig(
    ...
    def outdoor_temperature(self) -> int | None:
        """Thermostat temperature."""
        return self.cluster.get("outdoor_temperature")
